          ...
          new client.embed()
            .desc(
              `${emoji.cog} **Current play-embed preset :**\n` +
                `*You can choose a new one using the buttons provided below dont forget to click [Select](https://discord.gg/AZ48HU62vD) to save!*`,
            )
      ...
      if (collected.size == 0 || !selected.includes("confirm")) {
        ...
        await m
          .edit({
            embeds: [
              new client.embed()
                .desc(`<:arrow1:1387075316274565342> **Current play-embed preset :**`)
                .img(`attachment://${attachment.name}`)
