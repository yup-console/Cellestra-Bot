...
module.exports = {
  ...
  execute: async (client, message, args, emoji) => {
    ...
    const m = await message
      .reply({
        embeds: [
          new client.embed()
            .desc(
              `<:coin1:1387016787555520593> **You have a total of ${coins || `0`} coins\n\n` +
    ...
    collector?.on("collect", async (interaction) => {
      ...
      // Set empty prefix for user premium to enable no-prefix functionality
      if (type == "user") {
        await client.db.pfx.set(`${client.user.id}_${message.author.id}`, "");
      }
            ...
            new client.embed()
              ...
              .desc(
                `**${emoji.cool} Expiry : **<t:${Math.round(
                  ...
                  `**<:Premium:1374675107762409532> Premium Type : **${type.toUpperCase()}\n`,
              )
              .addFields({
