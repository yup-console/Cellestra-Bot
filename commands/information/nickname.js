module.exports = {
      ...
      return message.channel.send({
        ...
        embeds: [
          ...
          new client.emb().desc(
            ...
            `<:cross:1376076384493113407> ${message.author}: You can't nick me dumbo`,
      ...
      return message.channel.send({
        ...
        embeds: [
          ...
          new client.emb().desc(
            ...
            `<:cross:1376076384493113407> ${message.author}: You can't nick the server owner`,
  ...
  const bypass = "1118020446353371147"    
      ...
      return message.channel.send({
        ...
        embeds: [
          ...
          new client.emb().desc(
            ...
            `<:cross:1376076384493113407> ${message.author}: You can't do that due to role hierarchy`,
      ...
      return message.channel.send({
        embeds: [
          new client.emb().desc(
            `<:cross:1376076384493113407> ${message.author}: I can't do that due to role hierarchy`,
          ),
        ],
      });
      ...
      .send({
        ...
        embeds: [
          ...
          new client.emb().desc(
            ...
            `<:Tick:1376076194189152398> ${message.author}: Changed ${member.user.username}'s nick to ${nick}`,
