        ...
        ?.send({
          embeds: [
            new client.embed()
              ...
              .desc(
                `**Unable to find 247 voice channel**\n` +
                  `*Use \`${client.prefix}move\` to set a new 247 channel*`,
              ),
          ],
        })
        .catch(() => {});
        ...
        ?.send({
          embeds: [
            new client.embed()
              .title(`247 player error`)
              .desc(
                `**Unable to find 247 text channel**\n` +
                  `*This will now be used as default 247 channel*\n` +
                  `*Use \`${client.prefix}move\` to set a new 247 channel*`,
              ),
          ],
        })
      ...
      .send({
        embeds: [
          new client.embed()
            ...
            .desc(
              `**Joined <#${voice.id}> and bound to <#${text.id}>**`,
            ),
        ],
      })
      .then(async (m) =>
